...
CREATE TABLE `movieComment` (
  ...
  `txtComment` varchar(511) CHARACTER SET utf8 DEFAULT NULL,
  `tapeComment` varchar(1023) DEFAULT NULL,
  `times` int(11) DEFAULT NULL,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

SET @IMAGE_BASE_URL = "https://moves-1257154888.cos.ap-shanghai.myqcloud.com/"; -- FOR EXAMPLE: https://*****.ap-shanghai.myqcloud.com/
