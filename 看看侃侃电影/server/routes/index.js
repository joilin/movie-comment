...
// 获取我的已发布的影评列表
router.get('/commentsub', validationMiddleware, controllers.commentsub.shelfCommentList)

// 获取我的影评详细
router.get('/commentsub/:movieid', validationMiddleware, controllers.commentsub.shelfCommentDetail)
